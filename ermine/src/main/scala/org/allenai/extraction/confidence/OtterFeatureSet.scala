...
object OtterFeatureSet extends FeatureSet[OtterExtractionTupleAnnotated, Double](OtterFeatures.featureMap)

object OtterFeatures {
  type OtterFeature = Feature[OtterExtractionTupleAnnotated, Double]
  ...
  object nestedRelObj extends OtterFeature("relational object is a tuple") {
    override def apply(extr: OtterExtractionTupleAnnotated): Double = {
      extr.tuple match {
        case extr1: OtterExtractionTupleWithTupleRelObject => 1.0
        case _ => 0.0
      }
    }
  }

  object arg1ContainsPronoun extends OtterFeature("arg1 contains a pronoun or EX") {
    override def apply(extr: OtterExtractionTupleAnnotated): Double = {
      getTokensInPart(extr, "arg1").exists(tok => isPronoun(tok.posTag) || tok.posTag == "EX")
    }
  }

  object arg2sContainsPronoun extends OtterFeature("arg2s contains a pronoun or EX") {
    override def apply(extr: OtterExtractionTupleAnnotated): Double = {
  ...
  object blacklistedArg2s extends OtterFeature("arg2s consists of blacklisted words") {
    override def apply(extr: OtterExtractionTupleAnnotated): Double = {
      getTokensInPart(extr, "arg2s").forall(tok => blacklistArg2 contains tok.string)
    }
  }

  object arg1Noun extends OtterFeature("arg1 contains noun") {
    override def apply(extr: OtterExtractionTupleAnnotated): Double = {
      getTokensInPart(extr, "arg1").exists(tok => isNoun(tok.posTag) || isPronoun(tok.posTag))
    }
  }

  object arg2sNoun extends OtterFeature("arg2s contains noun") {
    override def apply(extr: OtterExtractionTupleAnnotated): Double = {
      getTokensInPart(extr, "arg2s").exists(tok => isNoun(tok.posTag) || isPronoun(tok.posTag))
    }
  }

  object arg1Proper extends OtterFeature("arg1 contains proper noun") {
    override def apply(extr: OtterExtractionTupleAnnotated): Double = {
      getTokensInPart(extr, "arg1").exists(tok => isProperNoun(tok.posTag))
    }
  }

  object arg2sProper extends OtterFeature("arg2s contains proper noun") {
    override def apply(extr: OtterExtractionTupleAnnotated): Double = {
      getTokensInPart(extr, "arg2s").exists(tok => isProperNoun(tok.posTag))
    }
  }

  object arg1BeforeRel extends OtterFeature("arg1 appears before rel in sentence") {
    override def apply(extr: OtterExtractionTupleAnnotated): Double = {
      getTokenSpanInPart(extr, "arg1") leftOf getTokenSpanInPart(extr, "rel")
    }
  }

  object arg2sAfterRel extends OtterFeature("arg2s appears after rel in sentence") {
    override def apply(extr: OtterExtractionTupleAnnotated): Double = {
      getTokenSpanInPart(extr, "arg2s") rightOf getTokenSpanInPart(extr, "rel")
    }
  }

  object arg1BordersRel extends OtterFeature("arg1 borders rel") {
    override def apply(extr: OtterExtractionTupleAnnotated): Double = {
      getTokenSpanInPart(extr, "arg1") borders getTokenSpanInPart(extr, "rel")
    }
  }

  object arg2sBordersRel extends OtterFeature("arg2s borders rel") {
    override def apply(extr: OtterExtractionTupleAnnotated): Double = {
      getTokenSpanInPart(extr, "arg2s") borders getTokenSpanInPart(extr, "rel")
    }
  }

  object relContainsVerb extends OtterFeature("rel contains verb") {
    override def apply(extr: OtterExtractionTupleAnnotated): Double = {
      getTokensInPart(extr, "rel") exists (tok => isVerb(tok.posTag))
    }
  }

  object relIsSingleVerb extends OtterFeature("rel is single verb") {
    override def apply(extr: OtterExtractionTupleAnnotated): Double = {
  ...
  object relStartWithVerbEndsWithPrep extends OtterFeature("rel matches VW+P") {
    override def apply(extr: OtterExtractionTupleAnnotated): Double = {
      val tokens = getTokensInPart(extr, "rel")
      ((tokens.length > 2) &&
  ...
  object relContiguous extends OtterFeature("rel contiguous") {
    override def apply(extr: OtterExtractionTupleAnnotated): Double = {
      getTokenSpanInPart(extr, "rel").length == getTokensInPart(extr, "rel").size
    }
  }

  object longArg1 extends OtterFeature("arg1 contains >= 10 tokens") {
    override def apply(extr: OtterExtractionTupleAnnotated): Double = {
      getTokensInPart(extr, "arg1").length >= 10
    }
  }

  object shortArg1 extends OtterFeature("arg1 contains < 3 tokens") {
    override def apply(extr: OtterExtractionTupleAnnotated): Double = {
      getTokensInPart(extr, "arg1").length < 3
    }
  }

  object longArg2s extends OtterFeature("arg2s contains >= 10 tokens") {
    override def apply(extr: OtterExtractionTupleAnnotated): Double = {
      getTokensInPart(extr, "arg2s").length >= 10
    }
  }

  object shortSentence extends OtterFeature("sentence contains < 10 tokens") {
    override def apply(extr: OtterExtractionTupleAnnotated): Double = {
      extr.allTokens.length < 10
    }
  }

  object longSentence extends OtterFeature("sentence contains >= 20 tokens") {
    override def apply(extr: OtterExtractionTupleAnnotated): Double = {
      extr.allTokens.length >= 20
    }
  }

  object conjBeforeRel extends OtterFeature("conj right before rel") {
    override def apply(extr: OtterExtractionTupleAnnotated): Double = {
  ...
  object arg1EqualsArg2s extends OtterFeature("arg1 equals arg2s") {
    override def apply(extr: OtterExtractionTupleAnnotated): Double = {
  ...
  class MatchWordRightBefore(part: String, wordPattern: String,
      labelOverride: String) extends OtterFeature(labelOverride + " right before " + part) {
  ...
  class MatchWordRightAfter(part: String, wordPattern: String,
      labelOverride: String) extends OtterFeature(labelOverride + " right after " + part) {
    def this(part: String, wordPattern: String) = this(part, wordPattern, wordPattern)
    override def apply(extr: OtterExtractionTupleAnnotated): Double = {
  ...
  class MatchWordAnywhereBefore(part: String, wordPattern: String,
      labelOverride: String) extends OtterFeature(labelOverride + " anywhere before " + part) {
    def this(part: String, wordPattern: String) = this(part, wordPattern, wordPattern)
    override def apply(extr: OtterExtractionTupleAnnotated): Double = {
  ...
  class MatchWordAnywherAfter(part: String, wordPattern: String,
      labelOverride: String) extends OtterFeature(labelOverride + " anywhere after " + part) {
    def this(part: String, wordPattern: String) = this(part, wordPattern, wordPattern)
    override def apply(extr: OtterExtractionTupleAnnotated): Double = {
  ...
  class PartContainsPostag(part: String, postagPattern: String,
      labelOverride: String) extends OtterFeature(s"$part contains $labelOverride") {
  ...
  def features: Seq[OtterFeature] = Seq(
    nestedRelObj,
    arg1ContainsPronoun,
  ...
  def featureMap: SortedMap[String, OtterFeature] = {
