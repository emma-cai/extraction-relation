...
object RunTrainingExtraction {
  ...
  private val disrel_sen_dir = "/Users/qingqingcai/Documents/Aristo/extraction-new/data/disrel_sens_v2"
...
//    test()
    // Build index based on Reverb data
    //   val MYIndex:Indexing = new Indexing()
    //    BuildIndex("/Users/qingqingcai/Downloads/ch9data", "../data/test/Index")

    // For each discourse-relation, search instances firstly and then search sentences
 ...
 //   println(disrel_goodRelationPhrase)
 ...
 //   disrel_tuples.foreach(p => println(p._1 + "\t" + p._2))
    
//    var MYData: Write = new Write()
//    MYData.rewrite(disrel_sen_dir, disrel_tuples)
  }
